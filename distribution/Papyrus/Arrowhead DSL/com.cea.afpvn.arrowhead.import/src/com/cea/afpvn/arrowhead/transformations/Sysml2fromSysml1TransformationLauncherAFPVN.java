 ...
 */
public class Sysml2fromSysml1TransformationLauncherAFPVN extends AbstractImportTransformationLauncher {
	 ...
	 * @param project 
	 */
	public Sysml2fromSysml1TransformationLauncherAFPVN(final ThreadConfig config, final Control baseControl, IResource project) {
	...
	protected IImportTransformation createTransformation(final URI transformationURI, final ThreadConfig config, final IDependencyAnalysisHelper analysisHelper) {
		return new Sysml2FromSysml1TransformationAFPVN(transformationURI, null, analysisHelper,project);
	}
